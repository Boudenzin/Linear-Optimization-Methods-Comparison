...
n_produtos = 10
n_meses = 12
capacidade_producao = 2000  # Aumentei a capacidade de produção
...
custos_fixos = {i: 50 * i for i in range(1, n_produtos + 1)}  # Reduzi os custos fixos

# Demandas (exemplo fictício: demanda aumenta com o produto e o mês, mas valores menores)
